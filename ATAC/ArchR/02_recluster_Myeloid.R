...
rna_proj <- readH5AD('../Myeloid_cell_raw.h5ad',reader = "python")
...
fineClust <- c()
fineClust[1] <- 'CD14_Mono'
fineClust[2] <- 'CD14_Mono'
fineClust[3] <- 'MDP'
fineClust[4] <- 'CD16_Mono'
fineClust[5] <- 'cDC'
fineClust[6] <- 'CD14_Mono'
fineClust[7] <- 'pDC'
