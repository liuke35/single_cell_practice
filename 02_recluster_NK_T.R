...
rna_proj <- readH5AD('../T_NK_cell_raw.h5ad',reader = "python")
...
markerGenes <- c("CD34","AVP",
                 "GNLY","NKG7","SELL","GZMB","GZMK","GZMA",
                 "IL7R","CCR7","FOXP3","CD4","CD8A","CD3D",
                 "IFNG","KLRB1","SLC4A10","MKI67")
...
fineClust <- c()
fineClust[1] <- 'CD8_effector_GZMK'
fineClust[2] <- 'CD8_EM'
fineClust[3] <- 'CD4_EM'
fineClust[4] <- 'CD8_Naive'
fineClust[5] <- 'CD4_Naive'
fineClust[6] <- 'NK'
fineClust[7] <- 'CD8_effector_GZMH'
fineClust[8] <- 'CD8_EM'
fineClust[9] <- 'Treg_FOXP'
fineClust[10] <- 'CD8_MAIT_CXCR6'
fineClust[11] <- 'CD4_EM'
fineClust[12] <- 'NK'
